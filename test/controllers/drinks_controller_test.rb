...
class DrinksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create drink" do
    assert_difference('Drink.count') do
      post drinks_url, params: { drink: { price: @drink.price, resteraunt_id: @drink.resteraunt_id, type: @drink.type } }, as: :json
    end
  ...
  test "should update drink" do
    patch drink_url(@drink), params: { drink: { price: @drink.price, resteraunt_id: @drink.resteraunt_id, type: @drink.type } }, as: :json
    assert_response 200
  end
